...
import { DeleteWorld } from "../../endpoints/Worlds";

function DeleteWorldPopup({setPopup, worldId}) {
    const navigate = useNavigate({});
    async function HandleDelete(){
        await DeleteWorld(worldId).then();
        setPopup(false);
    ...
    return (
        <div className="flex flex-col w-[200px] md:w-[400px]">
            <p className="text-[25px] text-center text-black dark:text-white">Are you sure you wanna delete this world?</p>
...
export default DeleteWorldPopup
