...
function DeleteTaskPopup({setReload, setPopup, taskData}) {
    ...
    return (
        <div className="flex flex-col w-[200px] md:w-[400px]">
            <p className="text-[25px] text-center text-black dark:text-white">Are you sure you wanna delete this task?</p>
